...
object Build extends Build {
  ...
  var gSettings = Defaults.coreDefaultSettings ++ Seq(
    ...
    libraryDependencies ++= Seq(
      ...
      "net.juniper"         %% "easy-rest-persistence" % "0.2.1"          withSources(),
      "net.juniper"         %% "easy-rest-orm" % "0.2.1"                  withSources(),
      "net.juniper"         %% "easy-rest-integration-patterns" % "0.2.1" withSources(),
