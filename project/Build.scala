...
object Build extends Build {
  ...
  var gSettings = Defaults.coreDefaultSettings ++ Seq(
    ...
    libraryDependencies ++= Seq(
      ...
      "net.juniper"         %% "easy-rest-core" % "0.1.5"                 withSources(),
      "net.juniper"         %% "easy-rest-persistence" % "0.1.5"          withSources(),
      "net.juniper"         %% "easy-rest-orm" % "0.1.5"                  withSources(),
      "net.juniper"         %% "easy-rest-integration-patterns" % "0.1.5" withSources(),
      "net.juniper"         % "jnc-library" % "0.1.4"                     withSources(),
